...
| "`MOD10A1V61`"                    | MOD10A1.061 Normalized Difference Snow Index from MODIS
...
==== MOD10A1V61 snow cover data      

`MOD10A1V61 observation directory:` specifies the location of the 1km resolution MOD10A1V61 fractional snow cover data

.Example _lvt.config_ entry         
....
MOD10A1V61 observation directory:          ./MOD10A1V61
....
